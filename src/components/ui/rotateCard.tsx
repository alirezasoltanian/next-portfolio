...
// <div class="grid min-h-screen place-items-center bg-slate-900 p-8">
//   <!-- We set the CSS variables in the parent element -->
//   <div class="relative h-60 w-80 rounded-[length:var(--border-radius)] border-[length:var(--border-width)] border-slate-600 bg-slate-800 [--anchor:100] [--border:1] [--glow:60] [--lightness:50%] [--opacity:1] [--radius:24] [--saturation:100%] [--speed:2] [--border-radius:calc(var(--radius)*1px)] [--border-width:calc(var(--border)*1px)] [--hue:300]">
//     <!-- 
...
//      -->
//     <span class="glow absolute inset-[calc(var(--border-width)*-1)] rounded-[length:var(--border-radius)] border-[length:var(--border-width)] border-transparent [mask:linear-gradient(transparent,transparent),linear-gradient(white,white)] ![mask-clip:padding-box,_border-box] ![mask-composite:intersect]">
//       <!-- 
//       Glowy spinny square
//       ---
