    ...
    <section ref={aboutRef} className="sectionAbout">
      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          ...
          <p>
            من علی رضا سلطانیان توسعه دهنده فرانت اند و بک اند با سه سال سابقه ،
            به دنیای وب ، تکنولوژی و دیجیتال مارکتینگ علاقه دارم. هر روز و هر
            لحظه در حال یادگیری هستم و این مسیر ادامه دارد... تمام مهارت های
            مورد نیاز به این رشته در بخش مهارت ها آورده ام و از طریق لینک های
            آورده شده می توانید به سابقه ام دسترسی داشته باشید و با من ارتباط
            بگیرید
          </p>
        </div>
      </div>
